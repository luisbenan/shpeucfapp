...
export const COLLEGE_CHANGED = 'college_changed';
export const MAJOR_CHANGED = 'major_changed';
export const POINTS_CHANGED = "points_changed";
export const PRIVILEGE_CHANGED = "privilege_changed";
...
export const SHOW_FIREBASE_ERROR = 'show_firebase_error';
...
export const OWNER_ID_CHANGED = "owner_id_changed"
export const OWNER_F_NAME_CHANGED = "owner_f_name_changed"
export const OWNER_L_NAME_CHANGED = "owner_l_name_changed"
export const OWNER_EMAIL_CHANGED = "owner_email_changed"
export const C_ID_CHANGED = "c_id_changed"
